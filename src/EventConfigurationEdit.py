...
# Form implementation generated from reading ui file 'EventConfigurationEdit.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.date_event_start_edit = QtWidgets.QDateEdit(self.ec_frame)
        self.date_event_start_edit.setMaximumSize(QtCore.QSize(150, 16777215))
        self.date_event_start_edit.setObjectName("date_event_start_edit")
        self.verticalLayout_5.addWidget(self.date_event_start_edit)
        ...
        self.date_event_end_edit = QtWidgets.QDateEdit(self.ec_frame)
        self.date_event_end_edit.setMaximumSize(QtCore.QSize(150, 16777215))
        self.date_event_end_edit.setObjectName("date_event_end_edit")
        self.verticalLayout_6.addWidget(self.date_event_end_edit)
        ...
        self.textbox_event_description_edit = QtWidgets.QPlainTextEdit(self.ec_frame)
        self.textbox_event_description_edit.setMaximumSize(QtCore.QSize(16777215, 250))
        self.textbox_event_description_edit.setObjectName("textbox_event_description_edit")
        self.verticalLayout_7.addWidget(self.textbox_event_description_edit)
        ...
        self.textbox_root_directory_edit = QtWidgets.QPlainTextEdit(self.dc_frame)
        self.textbox_root_directory_edit.setMaximumSize(QtCore.QSize(16777215, 28))
        self.textbox_root_directory_edit.setObjectName("textbox_root_directory_edit")
        self.verticalLayout_13.addWidget(self.textbox_root_directory_edit)
        self.textbox_red_team_folder_edit = QtWidgets.QPlainTextEdit(self.dc_frame)
        self.textbox_red_team_folder_edit.setMaximumSize(QtCore.QSize(16777215, 28))
        self.textbox_red_team_folder_edit.setObjectName("textbox_red_team_folder_edit")
        self.verticalLayout_13.addWidget(self.textbox_red_team_folder_edit)
        self.textbox_blue_team_folder_edit = QtWidgets.QPlainTextEdit(self.dc_frame)
        self.textbox_blue_team_folder_edit.setMaximumSize(QtCore.QSize(16777215, 28))
        self.textbox_blue_team_folder_edit.setObjectName("textbox_blue_team_folder_edit")
        self.verticalLayout_13.addWidget(self.textbox_blue_team_folder_edit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ec_label.setText(_translate("Dialog", "Event Configuration"))
